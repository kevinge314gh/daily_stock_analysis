...
CLAUDE_CLI_BACKEND_ID = "claude_cli"
AUTO_AGENT_BACKEND_ID = "auto"

CLAUDE_CODE_CLI_BACKEND_ID = "claude_code_cli"  # alias for claude_cli

SUPPORTED_GENERATION_BACKENDS = frozenset({LITELLM_BACKEND_ID, CODEX_CLI_BACKEND_ID, CLAUDE_CLI_BACKEND_ID, CLAUDE_CODE_CLI_BACKEND_ID})
